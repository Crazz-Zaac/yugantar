...
class PolicyService:
    ...
    def create_policy(
        ...
        db_session.flush()  # Ensure policy_id is generated without committing
        # db_session.commit()
    ...
    def update_policy(
        ...
        changes = PolicyService._get_model_changes(
            policy_class(**old_policy_snapshot), existing_policy
        )
